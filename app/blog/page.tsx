...
const page = () => {
  return (
    <section className='w-full flex flex-col items-center h-[100vh] justify-center'>
        ...
        <div className='relative max-container padding-container border border-emerald-500 grid grid-cols-3 gap-4'>
                { BLOGS.map((blog) => (
                    <div className='border border-red-800' key={blog.name}>
